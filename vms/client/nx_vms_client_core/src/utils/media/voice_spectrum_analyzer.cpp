...
void QnVoiceSpectrumAnalyzer::processData(const nx::media::audio::Format& format, const void* sampleData, int sampleCount) {
    ...
    {
        processData((const qint16*) sampleData, sampleCount);
    }
    else
    {
        processData((const qint32*) sampleData, sampleCount);
    }
}
