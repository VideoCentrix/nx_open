...
#include "../action_builder_fields/int_field.h"
...
const ItemDescriptor& VxMonitoringAction::manifest()
{
    static const auto kDescriptor = ItemDescriptor{
        .id = utils::type<VxMonitoringAction>(),
        .displayName = NX_DYNAMIC_TRANSLATABLE(tr("Trigger VideoCentrix Alert")),
        .description = "Trigger VideoCentrix Alert",
        ...
        .fields = {
            ...
            makeFieldDescriptor<ActionIntField>(
                "alertLevel",
                NX_DYNAMIC_TRANSLATABLE(tr("Alert Level")),
                "The alert tier level (1, 2, or 3)",
                {{"value", 1}, {"min", 1}, {"max", 3}}),
